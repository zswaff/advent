...
class R:
    ...
    def sz(self):
        return (self.mxx - self.mnx + 1) * (self.mxy - self.mny + 1) * (self.mxz - self.mnz + 1) * (1 if self.p else -1)
    ...
    def sub(self, other):
        ...
        for e in r[1:]:
            f = nr.pop()
            if all([f.mnx == e.mnx, f.mxx == e.mxx, f.mny == e.mny, f.mxy == e.mxy,
        ...
        for e in r[1:]:
            f = nr.pop()
            if all([f.mnx == e.mnx, f.mxx == e.mxx, f.mnz == e.mnz, f.mxz == e.mxz,
